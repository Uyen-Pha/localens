    ...
    places: [
      {
        ...
        foodVendors: [
          {
            id: "vendor-banh-mi-legacy",
            placeId: "place-banh-mi",
            slug: "vendor-banh-mi-legacy",
            title: { en: "Banh mi counter", vi: "Quầy bánh mì" },
            description: { en: "A food counter", vi: "Một quầy đồ ăn" },
            locationNote: "Ground floor",
            serviceType: "stall",
            capacityNote: "Small group",
            dietarySupport: { halal: "supported" },
            mobilitySupport: { "step-free": "supported" },
            openingHours: [
              { weekday: 6, opensAt: "08:00", closesAt: "17:00" },
            ],
            openingExceptions: [],
            status: "sellable",
            menuItems: [
              {
                id: "menu-banh-mi-legacy",
                vendorId: "vendor-banh-mi-legacy",
                slug: "banh-mi-legacy",
                title: { en: "Banh mi", vi: "Bánh mì" },
                description: { en: "Fresh sandwich", vi: "Bánh mì mới" },
                servingUnit: "portion",
                priceVndMin: 30_000,
                priceVndMax: 40_000,
      ...
      },
      {
        ...
        foodVendors: [
          {
            id: "vendor-market-legacy",
            placeId: "place-market",
            slug: "vendor-market-legacy",
            ...
            menuItems: [
              {
                id: "menu-market-legacy",
                vendorId: "vendor-market-legacy",
                slug: "market-noodles-legacy",
