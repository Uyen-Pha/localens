...
const COPY = {
  en: {
    ...
    disclosure: "Thesis demo account connected. Customer bookings, cancellation history, and fixed-departure guide assignments use current demo data.",
  ...
  vi: {
    ...
    disclosure: "Tài khoản demo đồ án đã kết nối. Booking khách hàng, lịch sử hủy và phân công hướng dẫn viên cho tour cố định hiển thị dữ liệu hiện có của bản demo.",
