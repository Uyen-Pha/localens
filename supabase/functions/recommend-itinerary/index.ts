...
import { createRecommendItineraryHandler } from "@/supabase/functions/_shared/recommend-itinerary";
import { createSupabaseRecommendAdapter } from "@/supabase/functions/_shared/supabase-itinerary-adapter";
