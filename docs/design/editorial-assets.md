...
- Verification command: `node scripts/process-editorial-assets.mjs check public/images/editorial/*.webp` (the checked-in command accepts explicit paths; PowerShell expansion was used as an explicit six-file list during generation). It verifies WebP decoding, exact dimensions, alpha bounds for marks, and the `900 KiB`/`500 KiB`/`80 KiB` limits.
...
- Generated source: `source-assets/saigon-artisan-hero-source.png` (1448 x 1086), ImageGen output `01a05119-259a-7901-96b2-97a92faec860/exec-3f10b4b9-416f-4745-8da7-373264eb5573.png`.
- Source-size normalization: because the generator's native 4:3 output is smaller than the contract minimum, the generated source was resized without cropping to `source-assets/saigon-artisan-hero-source-1600x1200.png` (1600 x 1200) with `node --input-type=module -e "import sharp from 'sharp'; await sharp('.superpowers/sdd/2026-08-30-localens-editorial-design-restoration/source-assets/saigon-artisan-hero-source.png').resize({width:1600,height:1200,fit:'fill'}).png().toFile('.superpowers/sdd/2026-08-30-localens-editorial-design-restoration/source-assets/saigon-artisan-hero-source-1600x1200.png')"`.
...
- Exact processing command:
  ...
  `node scripts/process-editorial-assets.mjs photo .superpowers/sdd/2026-08-30-localens-editorial-design-restoration/source-assets/saigon-artisan-hero-source-1600x1200.png public/images/editorial/saigon-artisan-hero.webp --width 1600 --height 1200`

- Output: `1600 x 1200`, `111,502` bytes, SHA-256 `7C7333849604BBA6D6406A660833125588EF4168D999A55CCDDC5D486A286A18`.
