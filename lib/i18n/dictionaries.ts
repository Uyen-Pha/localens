...
const customerHomeCopy: Record<Locale, Dictionary["home"]> = {
  en: {
    ...
    heroRoute: {
      ...
      disclosure: "Sample itinerary — not a quote, availability, or booking offer.",
    },
    heroStops: [
      {
        id: "market",
    ...
    demoDisclosure:
      "Sample tour catalog: fixed itineraries use synthetic data. Booking links open a local checkout preview; holds and simulated payments stay in this browser. No live booking or real charge is made.",
    tourCatalog: {
      catalogHeading: "Fixed tours in Ho Chi Minh City",
      catalogIntro: "Browse the tour catalog and inspect the facts behind each fixed route.",
      filtersLegend: "Filter the tour catalog",
      ...
      retryLabel: "Retry",
      filteringStatus: "Refreshing the tour catalog…",
      ...
      noResults: "No tours match these filters.",
      errorMessage: "The tour catalog could not be loaded.",
      retryableMessage: "Please try loading the tour catalog again.",
      correlationLabel: "Reference",
      disclosure: "Booking buttons open a local test flow only. No live booking or charge is made.",
      bookLabel: "Book",
    },
    ...
    trustItems: [
      ...
      },
      {
        ...
        description: "Generate or review a route built from approved sample places.",
      },
      {
        icon: "03",
    ...
    personalizationForm: {
      ...
      dietaryUnsupportedNote: "Current matching supports Halal and vegetarian only; describe other allergies or diets in special requests.",
      mobilityLabel: "Mobility needs",
      mobilityOptions: [
        { value: "none", label: "No special requirement" },
        { value: "step-free", label: "Need step-free options" },
      ],
      mobilityUnsupportedNote: "Current matching supports step-free access only; describe walking limits in special requests.",
      ...
      plannerLinkLabel: "Open the separate itinerary refinement preview",
      ...
      runtimePlannerLinkDisclosure: "Your preferences are saved in this tab. Sign in to a customer account to generate and save an AI-assisted itinerary.",
      ...
      preview: {
        ...
        "Preview: deterministic ranking stands in for AI. No network or paid AI service is called.",
      ...
      errorMessage: "The preview could not build a route.",
  ...
  vi: {
    ...
    demoDisclosure:
      "Danh mục tour trải nghiệm: tour cố định dùng dữ liệu tổng hợp. Liên kết đặt tour mở luồng thanh toán thử nghiệm; giữ chỗ và thanh toán mô phỏng chỉ được lưu trong trình duyệt. Không có đặt tour thật hay giao dịch thật.",
    tourCatalog: {
      catalogHeading: "Tour cố định tại Thành phố Hồ Chí Minh",
      catalogIntro: "Xem danh mục tour và kiểm tra thông tin của từng tuyến cố định.",
      filtersLegend: "Lọc danh mục tour",
      ...
      retryLabel: "Thử lại",
      filteringStatus: "Đang làm mới danh mục tour…",
      ...
      noResults: "Không có tour phù hợp với bộ lọc này.",
      errorMessage: "Không thể tải danh mục tour.",
      retryableMessage: "Hãy thử tải lại danh mục tour.",
      correlationLabel: "Mã tham chiếu",
      disclosure: "Nút đặt tour mở luồng thử nghiệm cục bộ. Chưa có đặt tour thực tế hay khoản tiền nào bị trừ.",
      bookLabel: "Đặt tour",
    },
    ...
    trustItems: [
      ...
      },
      {
        ...
        description: "Tạo hoặc xem một lịch trình từ các địa điểm mẫu đã duyệt.",
      },
      {
        icon: "03",
    ...
    personalizationForm: {
      ...
      dietaryUnsupportedNote: "Tính năng đối chiếu hiện hỗ trợ Halal và ăn chay; hãy ghi dị ứng hoặc chế độ khác trong yêu cầu đặc biệt.",
      mobilityLabel: "Nhu cầu di chuyển",
      mobilityOptions: [
        { value: "none", label: "Không có yêu cầu đặc biệt" },
        { value: "step-free", label: "Cần lựa chọn không bậc thang" },
      ],
      mobilityUnsupportedNote: "Tính năng đối chiếu hiện hỗ trợ lối đi không bậc; hãy ghi giới hạn đi bộ trong yêu cầu đặc biệt.",
      ...
      plannerLinkLabel: "Mở phần điều chỉnh lịch trình xem trước",
      ...
      runtimePlannerLinkDisclosure: "Nhu cầu được lưu trong tab này. Hãy đăng nhập tài khoản khách hàng để AI tạo và lưu lịch trình.",
      ...
      preview: {
        ...
        deterministicDisclosure:
        "Bản xem trước: xếp hạng theo quy tắc cố định đang đóng vai trò AI mô phỏng. Không gọi mạng hoặc dịch vụ AI trả phí.",
      ...
      errorMessage: "Không thể tạo lịch trình từ dữ liệu hiện có.",
...
const plannerCopy: Record<Locale, PlannerCopy> = {
  en: {
    ...
    runtimeDisclosure: "Signed-in itinerary planner — an itinerary is generated and saved only after you choose the action.",
    runtimeActiveDisclosure: "Signed-in itinerary planner — AI ranks approved options; LocalLens validates timing and cost before saving.",
    ...
    runtimeQuotaMessage: "Today's AI request limit has been reached. LocalLens will not retry automatically; try again after the limit resets.",
    ...
    runtimeErrorMessages: {
      ...
      quota: "Today's AI request limit has been reached. LocalLens will not retry automatically; try again after the limit resets.",
      ...
      "usd-disabled": "USD planning is not enabled for this experience. Return to personalization and choose VND.",
    ...
    defaultFixtureLabel: "Example route shown because no personalization handoff was found in this browser tab.",
    ...
    requestQuoteDisclosure: "Only a signed-in customer can actively confirm this revision and open the local request step. Nothing is sent to a live backend.",
  ...
  vi: {
    ...
    runtimeDisclosure: "Lịch trình có xác thực — chỉ tạo và lưu sau khi bạn chủ động chọn thao tác.",
    runtimeActiveDisclosure: "Lịch trình có xác thực — AI xếp hạng lựa chọn đã duyệt; LocalLens kiểm tra thời gian và chi phí trước khi lưu.",
    ...
    runtimeQuotaMessage: "Đã đạt giới hạn yêu cầu AI hôm nay. LocalLens sẽ không tự động thử lại; hãy thử sau khi hạn mức được làm mới.",
    ...
    runtimeErrorMessages: {
      ...
      quota: "Đã đạt giới hạn yêu cầu AI hôm nay. LocalLens sẽ không tự động thử lại; hãy thử sau khi hạn mức được làm mới.",
      ...
      "usd-disabled": "Trải nghiệm này chưa hỗ trợ lập lịch bằng USD. Hãy quay lại biểu mẫu và chọn VND.",
    ...
    defaultFixtureLabel: "Đang hiển thị lịch trình mẫu vì không tìm thấy dữ liệu cá nhân hóa trong tab trình duyệt này.",
    ...
    requestQuoteDisclosure: "Chỉ khách hàng đang đăng nhập mới có thể chủ động xác nhận phiên bản này và mở bước gửi yêu cầu cục bộ. Không có dữ liệu nào được gửi đến hệ thống thật.",
...
const customRequestCopy: Record<Locale, CustomRequestCopy> = {
  en: {
    ...
    intro: "Send this selected itinerary revision to the next local step for review.",
    demoDisclosure: "This local experience synchronizes the selected revision to your browser account after sign-in. It is not connected to a live backend, authentication provider, AI service, Stripe network, card details, or real charge.",
    noBackendAuthDisclosure: "A live product requires sign-in before submitting a custom request. This browser experience has no authentication service and continues only when you explicitly choose the local option.",
    ...
    continueLocalDemoLabel: "Continue in this browser",
    ...
    requestIntro: "This submits the selected revision to your browser account for administrator review; it does not contact a live backend or create a real booking.",
    submitRequestLabel: "Submit request locally",
    adminReviewHeading: "Admin review pending (simulated)",
    adminReviewPendingMessage: "Your request is saved in this browser and awaits administrator review.",
    ...
    quoteMessage: "This amount is based on sample quote details and remains unchanged in this local flow.",
  ...
  vi: {
    ...
    intro: "Gửi phiên bản lịch trình đã chọn sang bước tiếp theo để xem xét.",
    demoDisclosure: "Trải nghiệm này đồng bộ phiên bản đã chọn với tài khoản trong trình duyệt sau khi đăng nhập. Chưa kết nối hệ thống backend thật, dịch vụ xác thực, AI, mạng Stripe, thông tin thẻ hay giao dịch thật.",
    noBackendAuthDisclosure: "Sản phẩm thật cần đăng nhập trước khi gửi yêu cầu cá nhân hóa cho quản trị viên. Trải nghiệm trên trình duyệt này không có dịch vụ xác thực và chỉ tiếp tục khi bạn chủ động chọn.",
    ...
    continueLocalDemoLabel: "Tiếp tục trong trình duyệt này",
    ...
    dietaryAllergenLabel: "Lưu ý chế độ ăn/dị ứng",
    accessibilityWarningLabel: "Cảnh báo tiếp cận/điểm bán",
    requestHeading: "Gửi để quản trị viên xem xét",
    requestIntro: "Thao tác này gửi phiên bản đã chọn vào tài khoản trong trình duyệt để quản trị viên xem xét; không gọi hệ thống backend thật và không tạo đặt tour thật.",
    submitRequestLabel: "Gửi yêu cầu cục bộ",
    adminReviewHeading: "Đang chờ admin xem xét (mô phỏng)",
    adminReviewPendingMessage: "Yêu cầu đã được lưu trong trình duyệt và đang chờ quản trị viên xem xét.",
    ...
    quoteMessage: "Số tiền này dựa trên dữ liệu báo giá mẫu và không đổi trong luồng cục bộ này.",
