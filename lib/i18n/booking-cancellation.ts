...
const COPY = {
  en: {
    ...
    refreshUnavailable: "The cancellation response was received, but the latest booking status could not be loaded. Try again.",
    cancelledAt: "Cancelled at",
    reason: "Reason",
    noReason: "No reason provided",
    bookingManagement: "Booking management",
    bookingManagementIntro: "Booking status and immutable cancellation history are read-only.",
    emptyBookings: "No bookings are available.",
    bookingCreatedAt: "Booking created",
  ...
  vi: {
    ...
    refreshUnavailable: "Đã nhận phản hồi hủy đơn nhưng không thể tải trạng thái đơn mới nhất. Hãy thử lại.",
    ...
    emptyBookings: "Chưa có đơn đặt tour.",
    bookingCreatedAt: "Ngày tạo đơn",
    bookingId: "Mã đơn",
