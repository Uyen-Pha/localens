...
const TOUR_COPIES: TourCopy[] = [
  {
    ...
    attribution: "LocalLens editorial team (illustrative content)",
    license: "CC BY 4.0",
  ...
  },
  {
    ...
    summary: "An illustrative route combining food, history, markets, and craft.",
...
> = {
  ...
  vi: {
    ...
    "city-life-mix": {
      ...
      summary: "Tuyến trải nghiệm minh họa kết hợp ẩm thực, lịch sử, chợ và nghề thủ công.",
